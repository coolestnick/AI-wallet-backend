...
import useSaltStreamHandler from './useSaltStreamHandler'
...
const useAIChatStreamHandler = () => {
  ...
  const { handleSaltStreamResponse } = useSaltStreamHandler()
  ...
  const handleStreamResponse = useCallback(
    async (input: string | FormData) => {
      // Check if this is a Salt Wallet endpoint
      if (selectedEndpoint.includes('localhost:7777')) {
        return handleSaltStreamResponse(input)
      }
